...
Route::get('/search', [\App\Http\Controllers\Frontend\SearchController::class, 'index'])->name('frontend.search.index');
Route::get('/wishlist', [\App\Http\Controllers\Frontend\WishlistController::class, 'index'])->middleware('auth')->name('frontend.wishlist.index');
Route::post('/wishlist/{product}/toggle', [\App\Http\Controllers\Frontend\WishlistController::class, 'toggle'])->middleware('auth')->name('frontend.wishlist.toggle');
...
Route::get('/track-order', [\App\Http\Controllers\Frontend\TrackingController::class, 'index'])->name('frontend.tracking.index');
Route::get('/track-order/{deliveryTracking}', [\App\Http\Controllers\Frontend\TrackingController::class, 'show'])->name('frontend.tracking.show');
Route::get('/delivery-boy', [\App\Http\Controllers\Frontend\DeliveryBoyPanelController::class, 'index'])->name('frontend.delivery-boy.index');
Route::post('/delivery-boy/trackings/{deliveryTracking}/status', [\App\Http\Controllers\Frontend\DeliveryBoyPanelController::class, 'updateStatus'])->name('frontend.delivery-boy.status');
Route::post('/delivery-boy/trackings/{deliveryTracking}/cod', [\App\Http\Controllers\Frontend\DeliveryBoyPanelController::class, 'markCodCollected'])->name('frontend.delivery-boy.cod');
Route::get('/customer/login', [\App\Http\Controllers\Frontend\CustomerAuthController::class, 'showLogin'])->middleware('guest')->name('frontend.customer.login');
Route::post('/customer/login', [\App\Http\Controllers\Frontend\CustomerAuthController::class, 'login'])->middleware('guest')->name('frontend.customer.login.store');
Route::get('/customer/register', [\App\Http\Controllers\Frontend\CustomerAuthController::class, 'showRegister'])->middleware('guest')->name('frontend.customer.register');
Route::post('/customer/register', [\App\Http\Controllers\Frontend\CustomerAuthController::class, 'register'])->middleware('guest')->name('frontend.customer.register.store');
Route::post('/customer/logout', [\App\Http\Controllers\Frontend\CustomerAuthController::class, 'logout'])->middleware('auth')->name('frontend.customer.logout');
Route::get('/profile', [\App\Http\Controllers\Frontend\CustomerProfileController::class, 'profile'])->middleware('auth')->name('frontend.customer.profile');
